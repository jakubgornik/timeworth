...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('WORK', 'TIMEOFF', 'DELEGATION', 'SICK_LEAVE', 'HOLIDAY', 'UNPAID_LEAVE', 'MATERNITY_LEAVE', 'PATERNITY_LEAVE', 'MILITARY_LEAVE', 'ONBOARDING', 'TRAINING');
...
CREATE TABLE "Activity" (
    ...
    "userId" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "itemType" "ActivityType" NOT NULL,
